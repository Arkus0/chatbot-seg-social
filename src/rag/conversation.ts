...
const FAMILY_FALLBACK_RULES: AnalysisRule<IntentFamily>[] = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /\bcertificado digital\b/i,
      /\bautofirma\b/i,
      /\bcl@ve\b/i,
      /\bclave(?:\s+(?:pin|permanente))?\b/i,
      /\bfirma electr/i,
      /\bdnie?\b/i,
      /\bfnmt\b/i,
    ],
...
const OPERATION_RULES: AnalysisRule<IntentOperation>[] = [
  ...
  {
    value: "identificacion-electronica",
    patterns: [
      /\bcertificado digital\b/i,
      /\bautofirma\b/i,
      /\bcl@ve\b/i,
      /\bclave pin\b/i,
      /\bclave permanente\b/i,
      /\bfirma electr[oó]nica\b/i,
      /\bdnie?\b/i,
      /\bno me deja firmar\b/i,
      /\berror.*firma\b/i,
      /\bfnmt\b/i,
      /\bidentificaci[oó]n electr[oó]nica\b/i,
    ],
  },
  {
    value: "sin-certificado-sms",
    patterns: [/\bsms\b/i, /\bsin certificado\b/i, /\bsin cl@ve\b/i],
  },
  {
...
const OPERATION_STAGE_MAP: Record<IntentOperation, LifecycleStage> = {
  ...
  "identificacion-electronica": "preparacion",
